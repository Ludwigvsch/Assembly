...
ExceptionPtr__hla_	equ	fs:0
		...
		include	'program4.extpub.inc'




		section	'.data' data readable writeable align 16
		include	'program4.data.inc'

		dd	0	;dummy to keep linker happy
		section	'.bss' readable writeable align 16
		include	'program4.bss.inc'

		rb	4	;dummy to keep linker happy
		section	'.text' code readable executable align 16
		include	'program4.consts.inc'

		include	'program4.ro.inc'
...
;/* for this program. */
		...
		rol	byte ptr [L806_startingValue__hla_+0], 5	;/* startingValue */
		add	byte ptr [L806_startingValue__hla_+0], 1	;/* startingValue */
		push	dword 00h
		push	eax
		mov	al, byte ptr [L806_startingValue__hla_+0]	; (type int8 startingValue)
		mov	byte ptr [ESP+4], al
