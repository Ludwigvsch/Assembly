...
ExceptionPtr__hla_	equ	fs:0
		...
		include	'hasTwozs.extpub.inc'




		section	'.data' data readable writeable align 16
		include	'hasTwozs.data.inc'

		dd	0	;dummy to keep linker happy
		section	'.bss' readable writeable align 16
		include	'hasTwozs.bss.inc'

		rb	4	;dummy to keep linker happy
		section	'.text' code readable executable align 16
		include	'hasTwozs.consts.inc'

		include	'hasTwozs.ro.inc'
...
L824_hasTwozs__hla_:
		mov	dword ptr [L826_dEBX__hla_+0], ebx	;/* dEBX */
		mov	dword ptr [L827_dECX__hla_+0], ecx	;/* dECX */
		mov	dword ptr [L828_dEDX__hla_+0], edx	;/* dEDX */
		pop	dword ptr [L825_dReturnAddress__hla_+0]	;/* dReturnAddress */
		pop	ebx
		push	dword ptr [L825_dReturnAddress__hla_+0]	;/* dReturnAddress */
		mov	dx, 0

L830_putsRepeatLoop__hla_:
		cmp	[ebx+0], dh	;/* [ebx] */
		je	L831_putsEndLoop__hla_
		mov	ch, 122
		cmp	[ebx+0], ch	;/* [ebx] */
		je	L832_hasZ__hla_
		jmp	L833_after__hla_

L832_hasZ__hla_:
		inc	byte ptr [L829_counter__hla_+0]	;/* counter */

L833_after__hla_:
		inc	ebx
		jmp	L830_putsRepeatLoop__hla_

L831_putsEndLoop__hla_:
		mov	bh, byte ptr [L829_counter__hla_+0]	;/* counter */
		cmp	bh, 2
		je	L834_success__hla_
		mov	eax, 0
